...
public class CustomEntityFirework extends EntityFireworks {
    ...
    public CustomEntityFirework(WorldServer worldServer, Player... p) {
        super(worldServer);
        players = p;
        this.a(0.25F, 0.25F);
    }
            ...
            if (players != null) {
                if (players.length > 0) {
                    for (Player player : players) {
                        (((org.bukkit.craftbukkit.v1_8_R1.entity.CraftPlayer) player).getHandle()).playerConnection.sendPacket(new PacketPlayOutEntityStatus(this, (byte) 17));
                    }
