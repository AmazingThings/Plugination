...
public class SpawnBacon {
	...
	public static void spawnBase(int x, int y, int z, World w) {
		...
		Bukkit.getServer().broadcastMessage(ChatColor.YELLOW + "" + ChatColor.BOLD + "POWERUP SPAWNING...");
		Bukkit.getServer().broadcastMessage("");
		
		loc.getWorld().playSound(loc, Sound.ENDERMAN_TELEPORT, 100, 100);
